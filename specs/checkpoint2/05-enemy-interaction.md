...
- [v] (0.25 point) If we stand in front of the NPC, a warning sign will appear.
- [v] (0.25 point) If we press  button when the warning sign appears, switch scene into a battle scene.
- [ ] (2.5 points) Inside a battle scene, create a battle system
    ...
    - Each attack must reduce HP of opponent, when it reach 0, the opponent will lose (either ene my losing or user losing)